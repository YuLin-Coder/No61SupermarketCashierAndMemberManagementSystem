...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">兑换礼品列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="duihuanlipinList.do" name="myform" method="post">
									查询   礼品编号：<input name="lipinbianhao" type="text" id="lipinbianhao" class="form-control2" />  礼品名称：<input name="lipinmingcheng" type="text" id="lipinmingcheng" class="form-control2" />  手机号：<input name="shoujihao" type="text" id="shoujihao" class="form-control2" />
  ...
  %>>
                             ...
                             <td>${u.lipinbianhao}</td>    <td>${u.lipinmingcheng}</td>    <td>${u.suoxujifen}</td>    <td>${u.xingming}</td>    <td>${u.shoujihao}</td>    <td>${u.jifen}</td>    
                              ...
                              <td height="50" align="center"><a class="btn btn-info btn-small" href="doUpdateDuihuanlipin.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteDuihuanlipin.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="duihuanlipinDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="duihuanlipinList.do?page=1" >首页</a>
             <a href="duihuanlipinList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="duihuanlipinList.do?page=${page.page+1 }">下一页</a>
			<a href="duihuanlipinList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>

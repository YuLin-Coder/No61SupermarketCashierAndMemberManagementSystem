...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">账号充值列表</td>
						</tr>
					</table>
				</td>
			</tr>
  ...
  %>>
                             ...
                             <td>${u.xingming}</td>    <td>${u.shoujihao}</td>    <td>${u.yue}</td>    <td>${u.chongzhijine}</td>    
                              ...
                              <td height="50" align="center"><a class="btn btn-info btn-small" href="doUpdateZhanghaochongzhi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteZhanghaochongzhi.do?id=${u.id }"

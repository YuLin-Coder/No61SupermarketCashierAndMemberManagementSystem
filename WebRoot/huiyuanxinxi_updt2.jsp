	...
	<body>
			<form action="updateHuiyuanxinxi2.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<tr ><td width="200">手机号：</td><td><input name='shoujihao' disabled="disabled" type='text' id='shoujihao' value='' onblur='hsgcheck()' class="form-control" />&nbsp;*<label id='clabelshoujihao' style='margin-top:16px;' /></td></tr>
		...
		<tr ><td width="200">积分：</td><td><input name='jifen' disabled="disabled" type='text' id='jifen' value='' onblur='' class="form-control" /></td></tr>
		<tr ><td width="200">余额：</td><td><input name='yue'  disabled="disabled" type='text' id='yue' value='' onblur='checkform()' class="form-control" />&nbsp;<label id='clabelyue' style='margin-top:16px;' />必需数字型</td></tr>

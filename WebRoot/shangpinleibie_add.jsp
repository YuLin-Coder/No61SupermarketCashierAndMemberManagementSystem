	...
	<body>
			<form action="addShangpinleibie.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">添加商品类别</td>
						</tr>
						<tr ><td width="200">类别：</td><td><input name='leibie' type='text' id='leibie' value='' onblur='checkform()' class="form-control" />&nbsp;*<label id='clabelleibie' style='margin-top:16px;' /></td></tr>		<tr ><td width="200">说明：</td><td><textarea name='shuoming' cols='50' rows='5' id='shuoming' onblur='' class="form-control" style="width:600px; height:80px;" ></textarea></td></tr>		

	...
	<body>
			<form action="updateGoumaijiezhang.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.shangpinbianhao.value='${goumaijiezhang.shangpinbianhao}';</script>	<script language="javascript">document.form1.shangpinmingcheng.value='${goumaijiezhang.shangpinmingcheng}';</script>	<script language="javascript">document.form1.leibie.value='${goumaijiezhang.leibie}';</script>	<script language="javascript">document.form1.jiage.value='${goumaijiezhang.jiage}';</script>	<script language="javascript">document.form1.kucun.value='${goumaijiezhang.kucun}';</script>	<script language="javascript">document.form1.goumaishuliang.value='${goumaijiezhang.goumaishuliang}';</script>	<script language="javascript">document.form1.goumaijine.value='${goumaijiezhang.goumaijine}';</script>	<script language="javascript">document.form1.xingming.value='${goumaijiezhang.xingming}';</script>	<script language="javascript">document.form1.shoujihao.value='${goumaijiezhang.shoujihao}';</script>	<script language="javascript">document.form1.yue.value='${goumaijiezhang.yue}';</script>	
					 </table>
			</form>
   </body>
</html>

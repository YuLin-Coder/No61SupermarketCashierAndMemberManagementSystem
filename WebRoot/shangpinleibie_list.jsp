...
<html xmlns="http://www.w3.org/1999/xhtml">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">商品类别列表</td>
						</tr>
					</table>
				</td>
			</tr>
						...
						<tr align="left" >
							<td colspan="17">
								<form action="shangpinleibieList.do" name="myform" method="post">
									查询   类别：<input name="leibie" type="text" id="leibie" class="form-control2" />  说明：<input name="shuoming" type="text" id="shuoming" class="form-control2" />
  ...
  %>>
                             ...
                             <td>${u.leibie}</td>        
                              ...
                              <td height="50" align="center"><a class="btn btn-info btn-small" href="doUpdateShangpinleibie.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteShangpinleibie.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="shangpinleibieDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>

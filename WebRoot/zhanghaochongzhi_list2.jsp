...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="zhanghaochongzhiList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.xingming}</td>    <td>${u.shoujihao}</td>    <td>${u.yue}</td>    <td>${u.chongzhijine}</td>    
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateZhanghaochongzhi.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteZhanghaochongzhi.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="zhanghaochongzhiDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="zhanghaochongzhiList2.do?page=1" >首页</a>
             <a href="zhanghaochongzhiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="zhanghaochongzhiList2.do?page=${page.page+1 }">下一页</a>
			<a href="zhanghaochongzhiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
